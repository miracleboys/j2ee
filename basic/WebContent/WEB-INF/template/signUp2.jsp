    ...
    <body>
      ...
      <form:form name="dataForm" class="login-form" method="post" modelAttribute="user" action="${basePath}/users/add">
        ...
        <span class="message_${result.code} message_in">${result.msg}</span>
         ...
         <form:errors path="user.username" id="error1"/>
       <form:errors path="user.caption" id="error2"/>
       <form:errors path="user.valid" id="error3"/>
       <form:errors path="user.telephone" id="error4"/>
      </div>
